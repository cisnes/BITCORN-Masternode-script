...
COIN_TGZ='https://github.com/BITCORNProject/BITCORN/releases/download/2.1.0/BITCORN-2.1.0-daemon.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_BOOTSTRAP='https://github.com/BITCORNProject/BITCORN/releases/download/2.1.0/bootstrap.zip'
