...
COIN_TGZ='https://github.com/BITCORNProject/BITCORN/releases/download/v2.1/BITCORN-2.1-daemon-ubuntu_16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_BOOTSTRAP='https://github.com/BITCORNProject/BITCORN/releases/download/v2.1/bootstrap.zip'
